...
df_contra_debil.plot(x="nombre", y="probabilidad", kind="bar", stacked=False, figsize=(12, 14))
plt.title('10 usuarios más críticos')
plt.show()
...
df_desactualizadas.plot(x="nombre", kind="bar", stacked=False, figsize=(14, 16))
plt.title("5 páginas web políticas desactualizadas")
plt.show()
...
leyenda = ["Media de conexiones\n contraseña vulnerable", "Media de conexiones \ncontraseña no vulnerable"]
...
plt.title("Número contraseñas comprometidas vs. no comprometidas")
plt.show()
